    ...
    <body>
        ...
        <main>
            ...
            <div class="bloque_materia">
                ...
                <ul >
                    <?php
                        $consulta = "SELECT * FROM examenes WHERE idMateria = 'WD2001' AND matProfesor = '$mat'"; 
                        $resultado = consultaBD($consulta);
            ...
            <?php //Desplegar los grupos
                $consulta = "SELECT * FROM grupos WHERE idMateria = 'WD2001'"; //Obtener grupos
                $resultado = consultaBD($consulta);
                ...
                while($row2 = mysqli_fetch_array($resultado)){
                    ...
                    $consulta2 = "SELECT * FROM examenes WHERE idMateria = 'WD2001'"; //Obtener examenes
