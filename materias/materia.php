    ...
    <body>
        ...
        <main>
            ...
            <div class="bloque_materia">
                ...
                <ul >
                    <?php
                        $consulta = "SELECT * FROM examenes WHERE idMateria = '{idMat}' AND matProfesor = '$mat'"; 
                        $resultado = consultaBD($consulta);
            ...
            <?php //Desplegar los grupos
                $consulta = "SELECT * FROM grupos WHERE idMateria = '{idMat}'"; //Obtener grupos
                $resultado = consultaBD($consulta);
                ...
                while($row2 = mysqli_fetch_array($resultado)){
                    ...
                    $consulta2 = "SELECT * FROM examenes WHERE idMateria = '{idMat}'"; //Obtener examenes
